...
local plug_map = {
    -- Buffers
    ["n|<S-h>"] = map_cr("bp"):with_noremap():with_silent(),
    ["n|<S-l>"] = map_cr("bn"):with_noremap():with_silent(),
    -- Bufferline
    ...
    -- wide search
    ["n|<leader>rp"] = map_cr("lua require('spectre').open()<CR>"):with_silent():with_noremap(),
    ["n|<leader>rf"] = map_cr("lua require('spectre').open_file_search()<CR>"):with_silent():with_noremap(),
    ["n|<leader>rs"] = map_cr("lua require('spectre').open_visual({select_word=true})<CR>"):with_silent():with_noremap()
}
